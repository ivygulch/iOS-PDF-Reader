...
#import "CDemoTableViewCell.h"

#import <objc/runtime.h>

@implementation CDemoTableViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
    ...
    if ((self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) != NULL)
		...
		UIViewController *theViewController = [[theClass alloc] initWithNibName:NSStringFromClass(theClass) bundle:NULL];
